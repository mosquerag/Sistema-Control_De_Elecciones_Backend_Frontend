...
export default function Table({
  ...
  return (
    <div
      className="p-1 w-full bg-white dark:bg-blue-950 divide-y divide-gray-200 dark:divide-slate-500 rounded-2xl shadow-lg">
      {/* ── Botón exportar ──────────────────────────────────────── */}
      <div className="flex justify-between items-center mb-1">
        {showExport && (
          <button
            ...
            className="flex items-center gap-2 text-gray-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead
            className="bg-white dark:bg-blue-950 divide-y divide-gray-200 dark:divide-slate-400 border-b border-gray-300 dark:border-slate-500" >
            <tr>
              {showCheckbox && (
              ...
              {columns.map((column, index) => (
                <th
                  ...
                  className={`p-1 text-left font-bold transition-colors whitespace-nowrap text-gray-700 dark:text-slate-300
                    ${
                      column.sortable !== false
          ...
          <tbody
            className="bg-white dark:bg-blue-950 divide-y divide-gray-200 dark:divide-slate-500"
          >
            {paginatedData.map((row, rowIndex) => {
              ...
              return (
                <tr
                  ...
                  className="border-b border-gray-100 dark:border-slate-700 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer group"
                >
                  {showCheckbox && (
                    <td className="p-1">
                      <input
      ...
      <footer className="mt-2 flex flex-wrap items-center justify-between gap-2 pt-2 px-1">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-100">
          ...
          <select
            ...
            className="border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1 text-sm text-gray-700 dark:text-slate-200
             bg-white dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-400  cursor-pointer"
 >
