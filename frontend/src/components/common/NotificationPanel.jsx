...
export function NotificationPanel({
  ...
  return (
    <>
      ...
      {/* ── Panel ────────────────────────────────────────── */}
      <div className="fixed right-0 top-0 h-full w-full sm:w-96 bg-white dark:bg-slate-800 shadow-2xl z-50 flex flex-col transition-transform duration-300 ease-in-out">
        {/* ── Header ───────────────────────────────────── */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-900 dark:from-blue-700 dark:to-blue-900/5 px-4 py-4 text-white flex-shrink-0">
          ...
          {!loading && notificaciones.length > 0 && (
            <div className="divide-y divide-gray-100 dark:divide-slate-700">
              {notificaciones.map((notif) => (
                <div key={notif._id} className="p-4 transition-colors hover:bg-blue-500/50 dark:hover:bg-blue-800/50" >
