...
const BG_IMAGES = [
  "https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=1600&q=800",
  "https://images.unsplash.com/photo-1589994965851-a8f479c573a9?w=600&q=65",
  "https://images.unsplash.com/photo-1540910419892-4a36d2c3266c?w=1600&q=800",
  "https://images.unsplash.com/photo-1494172961521-33799ddd43a5?w=1600&q=800",
  "https://images.unsplash.com/photo-1558008258-3256797b43f3?w=1600&q=800",
  "https://images.unsplash.com/photo-1569288063643-5d29ad64df09?w=1600&q=800",
  "https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=1600&q=800",
  "https://images.unsplash.com/photo-1555848962-6e79363ec58f?w=1600&q=800",
  "https://images.unsplash.com/photo-1588681664899-f142ff2dc9b1?w=1600&q=800",
  "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=1600&q=800",
  "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=1600&q=800"
];
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center overflow-hidden bg-slate-100/10 dark:bg-slate-900/50">
      ...
      <div className="hidden md:block absolute bottom-8 right-10 animate-bounce">
        <div className="w-6 h-10 rounded-full border-2 border-blue-400 dark:border-blue-300 flex justify-center pt-2">
          <div className="w-1 h-2 rounded-full bg-blue-400 dark:bg-blue-300" />
        </div>
      </div>
    </section>
  );
