...
import { getGoogleAuthUrl } from "@/config/googleOAuth";
...
const ForgotPassword = () => {
  ...
  const handleVerifyIdentity = async (e) => {
    ...
    try {
      ...
      // Flujo directo (como antes): el token llega en la respuesta,
      // sin depender de que llegue un correo — aplica a ciudadano y candidato.
      ...
      } else if (data?.error === "GOOGLE_AUTH_USER") {
        // Solo puede pasar con un admin vinculado a Google — mantiene su propio flujo
        Swal.fire({
          icon: "info",
          title: "Esta cuenta usa Google",
          text: "Esta cuenta inicia sesión con Google — no tiene una contraseña que restablecer aquí.",
          showCancelButton: true,
          confirmButtonText: "Iniciar sesión con Google",
