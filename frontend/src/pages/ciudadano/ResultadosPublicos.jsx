...
const ResultadosPublicos = () => {
  ...
  return (
    <>
      ...
      {resultados && (
        <div className="bg-blue-100 dark:bg-blue-800 border border-blue-200 dark:border-blue-600 rounded-2xl overflow-hidden">
          {/* ── Header ── */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-blue-200 dark:border-blue-600">
            <div>
            ...
            <div className="bg-purple-300 dark:bg-purple-700 border border-purple-500 dark:border-purple-500 rounded-xl px-4 py-2 text-center">
          ...
          {resultados.resultados?.length > 0 && (
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col items-center justify-center gap-5 px-6 py-6 border-b md:border-b-0 md:border-r border-blue-200 dark:border-blue-700 md:min-w-[220px]">
              ...
              <div className="flex-1 px-6 py-6">
                <p className="text-xs font-medium text-blue-950 dark:text-blue-100 uppercase tracking-wider mb-4">
                ...
                <div className="grid grid-cols-3 gap-3 mt-6 pt-4 border-t border-slate-200 dark:border-slate-700">
                  <div className="bg-sky-200 dark:bg-sky-700 rounded-xl p-3 text-center border border-sky-300 dark:border-sky-500">
                  ...
                  <div className="bg-teal-200 dark:bg-teal-700 border border-teal-300 dark:border-teal-500 rounded-xl p-3 text-center">
                    <p className="text-xs text-slate-600 dark:text-slate-200 mb-1">
                      Mayor %
                    </p>
                  ...
                  <div className="bg-orange-200 dark:bg-orange-700 dark:orange-teal-500 border border-orange-300 dark:orange-teal-500 rounded-xl p-3 text-center">
                    <p className="text-xs text-slate-600 dark:text-slate-200 mb-1">
                      Participación
                    </p>
