...
const MisResultados = () => {
  ...
  return (
    <>
                ...
                {candidatosConVotos.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center gap-3 py-3 border-b border-blue-500 dark:border-blue-700 last:border-0 ${
                        esTu
                          ? "rounded-xl bg-green-200 dark:bg-green-700/70 px-3 -mx-3"
                          : ""
                      }`}
                    >
                      <span
      ...
      <div className="mt-4 bg-cyan-100 dark:bg-cyan-900/50 border border-cyan-200 dark:border-cyan-800 rounded-xl p-4">
        <div className="flex items-center justify-center gap-2 text-cyan-700 dark:text-cyan-300 text-sm">
