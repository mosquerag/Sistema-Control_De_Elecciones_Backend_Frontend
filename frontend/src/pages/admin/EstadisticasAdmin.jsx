    ...
    <>
      ...
      {idEleccion && resultados && (
        <div className="space-y-3">
          <div className="bg-blue-400/20 dark:bg-blue-600/40 border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between px-3 py-2 border-b border-slate-200 dark:border-slate-700">
              ...
              <div className="flex items-center gap-2 bg-purple-200 dark:bg-purple-700 border border-purple-400 dark:border-purple-400 text-purple-800 dark:text-purple-100 px-3 py-1.5 rounded-lg w-fit">
                <Users className="w-4 h-4" />
                <div>
                  <p className="text-xs font-medium">Total Votantes</p>
                  <p className="text-purple-800 dark:text-purple-100 font-bold leading-tight">
              ...
              <div className="flex items-end justify-center gap-3 px-3 pt-2">
                ...
                {resultados.resultados[1] && (
                  <div className="flex flex-col items-center gap-1 flex-1">
                    ...
                    <p className="text-xs font-bold text-blue-500 dark:text-blue-200">
            ...
            <div className="px-3 py-1.5">
              ...
              <div className="overflow-x-auto rounded-xl">
                <div className="bg-cyan-300 dark:bg-cyan-800 border border-cyan-500 dark:border-cyan-600 rounded-xl overflow-hidden min-w-[500px]">
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="border-b border-cyan-500 dark:border-cyan-600">
                        <th className="text-left font-semibold text-black dark:text-white px-3 py-2 whitespace-nowrap">
                          #
                        </th>
                        <th className="text-left font-semibold text-black dark:text-white px-3 py-2 whitespace-nowrap">
                          Candidato
                        </th>
                        <th className="text-right font-semibold text-black dark:text-white px-3 py-2 whitespace-nowrap">
                          Votos
                        </th>
                        <th className="text-right font-semibold text-black dark:text-white px-3 py-2 whitespace-nowrap">
                          %
                    ...
                    <tbody>
                      {resultados.resultados?.map((resultado, index) => {
                        ...
                        return (
                          <tr
                            key={index}
                            className="border-b border-cyan-500 dark:border-cyan-600 last:border-0"
                          >
                            <td
                            ...
                            <td className="px-3 py-2 text-right text-black dark:text-white whitespace-nowrap">
                              {resultado.votos}
                            </td>
                            <td
            ...
            {resultados.resultados?.length > 0 && (
              <div className="grid grid-cols-3 gap-2 px-3 pb-2">
                ...
                <div className="bg-yellow-200 dark:bg-yellow-600 border border-yellow-500 dark:border-yellow-500 rounded-xl p-2 text-center">
                  <Trophy className="w-4 h-4 mx-auto text-yellow-500 mb-0.5" />
                  <p className="text-xs text-black dark:text-white">
                    Ganador
                  </p>
                  <p className="text-xs font-semibold text-sky-900 dark:text-sky-200  leading-tight truncate">
                    {resultados.resultados[0]?.candidato?.nombre
                      ?.split(" ")
                      .slice(0, 2)
                      .join(" ")}
                ...
                <div className="bg-green-200 dark:bg-green-700 border border-green-500 dark:border-green-500 rounded-xl p-2 text-center">
                ...
                <div className="bg-blue-300 dark:bg-blue-700 border border-blue-500 dark:border-blue-500 rounded-xl p-2 text-center">
                  <Users className="w-4 h-4 mx-auto text-blue-700 dark:text-blue-300 mb-0.5" />
