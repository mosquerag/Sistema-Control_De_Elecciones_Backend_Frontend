...
app.use(
  session({
    ...
    store: MongoStore.create({
      ...
      ttl: 24 * 60 * 60, // 24 horas, en segundos (coincide con maxAge de la cookie)
    }),
    cookie: {
      secure: isProduction,
      httpOnly: true,
...
app.use("/api/votos", voteLimiter, votosRoutes); /**con restrincion de votos  */
// app.use("/api/votos", votosRoutes); /** sin restiricon de votos */
// Rutas protegidas
