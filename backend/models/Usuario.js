...
const usuarioSchema = new mongoose.Schema(
  {
    ...
    email: {
      type: String,
      // NO poner default: null — dejar undefined para que el índice sparse funcione
      required: [
        function () {
          return this.rol === "admin" || this.esGoogleAuth === true;
        },
        "El email es obligatorio para administradores y cuentas de Google",
      ],
      lowercase: true,
      trim: true,
      validate: {
